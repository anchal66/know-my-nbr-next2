...
import { getFollowers, FollowResponse } from '@/lib/follow'
...
export default function MyFollowersPage() {
  ...
  async function fetchData(isActive: boolean, page: number) {
    try {
      setLoading(true)
      setError(null)
      const response = await getFollowers(page, size, isActive)
      if (isActive) {
  ...
  return (
    <div className="p-4 space-y-6">
      <h1 className="text-2xl md:text-3xl font-bold text-foreground">My Followers</h1>
      ...
      <p className="hidden md:block text-muted-foreground">
        Here you can find all users who have followed you. 
        <br />
        “Active Followers” means they are currently folowwing you, 
        while “Past Followers” is the list of people whose follow ended.
      </p>
