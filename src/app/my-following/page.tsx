    ...
    return (
        <div className="p-4 space-y-6">
            ...
            <p className="hidden md:block text-muted-foreground">
                ...
                <br />
                “Active Followers” means they are currently you are following this user,
                while “Past Followers” is the list of people you followed in the past.
            </p>
            ...
            {!loading && !error && (
                <FollowerTable
                    ...
                    type={activeTab === 'ACTIVE' ? 'CURRENT' : 'PAST'}
                />
            )}
...
function FollowerTable({ followers, handleFollowBack, isActiveTab, type }: FollowerTableProps) {
